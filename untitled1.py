...
Original file is located at
    https://colab.research.google.com/drive/17AaGMn-LwZgHv3GkqeNfPWvry0i01iig
"""

# prompt: escreva um comando em python para uma lambda de AWS somente se conectar a uma api que tem chave
...
# prompt: preciso de outro script em python que conecte a um bucket S3 da aws
...
# prompt: agoora outro script em python que conecte a um banco de dados RDS da AWS
